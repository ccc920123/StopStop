...
public class BaseDialog extends Dialog implements android.view.View.OnClickListener {
    ...
    public Button mBtnButton1;// 底部按钮1
    public Button mBtnButton2;// 底部按钮2
    public Button mBtnButton3;// 底部按钮3
    ...
    public BaseDialog(Context context) {
        super(context, R.style.Theme_Light_ListDialog);
        //        super(context);
        mContext = context;
    ...
    public static BaseDialog getDialog(Context context, int titleId, int message) {
        return getDialog(context, titleId, context.getResources().getString(message), null, null, null, null, null,
                null);
    }

    public static BaseDialog getDialog(Context context, int titleId, CharSequence message, CharSequence button1,
                                       DialogInterface.OnClickListener listener1) {
        return getDialog(context, titleId, message, button1, listener1, null, null, null, null);
    }

    public static BaseDialog getDialog(Context context, int titleId, int message, int button1, DialogInterface
            .OnClickListener listener1) {
        return getDialog(context, titleId, context.getResources().getString(message), context.getResources()
                .getString(button1), listener1, null, null, null, null);
    }

    public static BaseDialog getDialog(Context context, int titleId, CharSequence message, CharSequence button1,
                                       DialogInterface.OnClickListener listener1, CharSequence button2,
                                       DialogInterface.OnClickListener listener2) {
        return getDialog(context, titleId, message, button1, listener1, button2, listener2, null, null);
    }

    public static BaseDialog getDialog(Context context, int titleId, int message, int button1, DialogInterface
            .OnClickListener listener1, int button2, DialogInterface.OnClickListener listener2) {
        return getDialog(context, titleId, context.getResources().getString(message), context.getResources()
                .getString(button1), listener1, context.getResources().getString(button2), listener2, null, null);
    }

    public static BaseDialog getDialog(Context context, int titleId, String message, int button1, DialogInterface
            .OnClickListener listener1, int button2, DialogInterface.OnClickListener listener2) {
        return getDialog(context, titleId, message, context.getResources().getString(button1), listener1, context
                .getResources().getString(button2), listener2, null, null);
    }
    ...
    public boolean buttonIsExist(CharSequence button1, DialogInterface.OnClickListener listener1, CharSequence
            button2, DialogInterface.OnClickListener listener2, CharSequence button3, DialogInterface.OnClickListener
            listener3) {
        if ((button1 != null && listener1 != null) || (button2 != null && listener2 != null) || (button3 != null &&
                listener3 != null)) {
