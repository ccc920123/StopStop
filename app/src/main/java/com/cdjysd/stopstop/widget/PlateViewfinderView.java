...
public class PlateViewfinderView extends View{
        ...
        private boolean boo;
        public     int  length =0;
//    public int framelength=250;
//    public  int frameHight=350;
        public int t, b, l, r;
        public int width,height,preWidth,preHeight, surfaceWidth,surfaceHeight;
        public PlateViewfinderView(Context context, boolean boo, int preWidth, int preHeight) {
            super(context);
//		this.w = w;
//		this.h = h;
