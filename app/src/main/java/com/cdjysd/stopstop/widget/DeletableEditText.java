...
/**
 * @ClassName DeleteableEditText
 * @Description 自定义EditText空间，带图标和一件删除内容功能
 * @date 2016-8-2 上午9:33:53
 */
public class DeletableEditText extends android.support.v7.widget.AppCompatAutoCompleteTextView {
	 ...
	 * getPaddingRight()表示: 控件左边到clean的图标右边缘的区域 �?以这两�?�之间的区域刚好是clean的图标的区域
	 */
	@Override
