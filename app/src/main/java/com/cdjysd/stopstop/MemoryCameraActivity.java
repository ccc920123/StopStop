...
import com.cdjysd.stopstop.bean.Devcode;
import com.cdjysd.stopstop.utils.FrameCapture;
import com.cdjysd.stopstop.utils.Utils;
 ...
 * 识别
 */
public class MemoryCameraActivity extends AppCompatActivity implements
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 5) {
                ...
                if (rotation == 90 || rotation == 270) {
                    myview = new PlateViewfinderView(MemoryCameraActivity.this, false, preWidth, preHeight);
                } else {
                    myview = new PlateViewfinderView(MemoryCameraActivity.this, true, preWidth, preHeight);
                }
                re.addView(myview);
                if (camera != null) {
...
//		System.out.println("左  ："+prp.plateIDCfg.left+"   右  ："+prp.plateIDCfg.right+"     高："+prp.plateIDCfg.top+"    底："+prp.plateIDCfg.bottom);
    ...
    private void setLinearRegion() {
        ...
        prp.plateIDCfg.left = preHeight / 2 - (myview.length + 80) * preWidth / surfaceView.getHeight();
        prp.plateIDCfg.right = preHeight / 2 + (myview.length + 80) * preWidth
                / surfaceView.getHeight();
