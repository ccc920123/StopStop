    ...
    public class MyBinder extends Binder {
        ...
        public void setRecogArgu(String pic, int imageformat, boolean bGetVersion, int bVertFlip, int bDwordAligned) {
            ...
            if(PlateRecogService.this.iTH_InitPlateIDSDK != 0) {
                ...
                if(bGetVersion) {
                    PlateRecogService.this.returnGetVersion = PlateRecogService.this.plateIDAPI.TH_GetVersion();
                }

                PlateRecogService.this.plateIDAPI.TH_SetImageFormat(imageformat, bVertFlip, bDwordAligned);
                PlateRecogService.this.configArg = new ConfigArgument();
                int TH_SetEnabledPlateFormat;
                if(PlateRecogService.this.configArg.cfgs != null && PlateRecogService.this.configArg.cfgs.length >= 26) {
                    TH_SetEnabledPlateFormat = PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.tworowyellow);
                    PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.armpolice);
                    PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.tworowarmy);
                    PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.tractor);
                    PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.onlytworowyellow);
                    PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.embassy);
                    PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.onlylocation);
                    PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.armpolice2);
                }

                int TH_SetRecogThreshold;
                int TH_SetAutoSlopeRectifyMode;
                if(PlateRecogService.this.configArg.cfgs != null && PlateRecogService.this.configArg.cfgs.length >= 18) {
                    TH_SetEnabledPlateFormat = PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(PlateRecogService.this.configArg.dFormat);
                    TH_SetRecogThreshold = PlateRecogService.this.plateIDAPI.TH_SetRecogThreshold(PlateRecogService.this.configArg.nPlateLocate_Th, PlateRecogService.this.configArg.nOCR_Th);
                    TH_SetAutoSlopeRectifyMode = PlateRecogService.this.plateIDAPI.TH_SetAutoSlopeRectifyMode(PlateRecogService.this.configArg.bIsAutoSlope, PlateRecogService.this.configArg.nSlopeDetectRange);
                    int TH_SetProvinceOrder = PlateRecogService.this.plateIDAPI.TH_SetProvinceOrder(PlateRecogService.this.configArg.szProvince);
                    int var11;
                    if(PlateRecogService.this.configArg.nContrast != 0) {
                        var11 = PlateRecogService.this.plateIDAPI.TH_SetContrast(PlateRecogService.this.configArg.nContrast);
                    }

                    var11 = PlateRecogService.this.plateIDAPI.TH_SetDayNightMode(PlateRecogService.this.configArg.c_Config.bIsNight);
                } else {
                    TH_SetEnabledPlateFormat = PlateRecogService.this.plateIDAPI.TH_SetEnabledPlateFormat(0);
                    TH_SetRecogThreshold = PlateRecogService.this.plateIDAPI.TH_SetRecogThreshold(7, 5);
                    TH_SetAutoSlopeRectifyMode = PlateRecogService.this.plateIDAPI.TH_SetContrast(9);
                }
        ...
        public void setRecogArgu(PlateCfgParameter cfgparameter, int imageformat, int bVertFlip, int bDwordAligned) {
            ...
            if(PlateRecogService.this.iTH_InitPlateIDSDK != 0) {
                ...
                int iTH_SetRecogThreshold = PlateRecogService.this.plateIDAPI.TH_SetRecogThreshold(cfgparameter.nPlateLocate_Th, cfgparameter.nOCR_Th);
                int iTH_SetAutoSlopeRectifyMode = PlateRecogService.this.plateIDAPI.TH_SetAutoSlopeRectifyMode(cfgparameter.bIsAutoSlope, cfgparameter.nSlopeDetectRange);
                int iTH_SetProvinceOrder = PlateRecogService.this.plateIDAPI.TH_SetProvinceOrder(cfgparameter.szProvince);
                ...
                if(prp.versionfile != null && !prp.versionfile.equals("")) {
                    ...
                    if(check1 == -10090 && devCheck1 == 0) {
                        if(MathRandom.PercentageRandom() == 5) {
                            Toast.makeText(PlateRecogService.this.getApplicationContext(), "您的授权已到期，将不能使用识别功能", Toast.LENGTH_SHORT).show();
                        }
